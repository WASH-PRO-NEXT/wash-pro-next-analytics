...
import { apiListBounded, apiListCatalog } from '@dashboard/api/client';
import { PageHeader, Loading, StatCard, getPeriodLabelMap } from '@dashboard/components/UI';
import { DataTable, type DataTableBulkAction, type DataTableColumn, type DataTableFilter } from '@dashboard/components/DataTable';
import { DEFAULT_LIVE_INTERVAL_MS } from '@dashboard/constants/live';
import { usePolling } from '@dashboard/hooks/usePolling';
import { useCurrency } from '@dashboard/hooks/useCurrency';
import { statsScopeHint, useStatsScopeFilter } from '@dashboard/hooks/useStatsScopeFilter';
import { formatMoney, formatDateTime } from '@dashboard/utils/format';
...
} from '@dashboard/utils/statsAggregation';
import type { FinanceStat, Post, Wash } from '@dashboard/types';
